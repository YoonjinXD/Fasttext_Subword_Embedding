...
According to the paper and the presentation(on Youtube), the researchers suggest that the short n-grams(n=4) is good to capture syntactic information and the longer n-grams(n=6) is good to capture semantic information. 
